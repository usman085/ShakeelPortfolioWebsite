...
function _populate() {
    if (!_populated) {
        ...
        if (_iphone = /\b(iPhone|iP[ao]d)/.exec(t), _ipad = /\b(iP[ao]d)/.exec(t), _android = /Android/i.exec(t), _native = /FBAN\/\w+;/i.exec(t), _mobile = /Mobile/i.exec(t), _win64 = !!/Win64/.exec(t), e) {
            ...
            _ie_real_version = s ? parseFloat(s[1]) + 4 : _ie, _firefox = e[2] ? parseFloat(e[2]) : NaN, _opera = e[3] ? parseFloat(e[3]) : NaN, _chrome = (_webkit = e[4] ? parseFloat(e[4]) : NaN) && (e = /(?:Chrome\/(\d+\.\d+))/.exec(t)) && e[1] ? parseFloat(e[1]) : NaN
...
class ClapatWebGL {
    ...
    resize() {
        this.width = this.container.offsetWidth, this.height = this.container.offsetHeight, this.renderer.setSize(this.width, this.height), this.camera.aspect = this.width / this.height, this.imageAspect = this.textures[0].image.height / this.textures[0].image.width;
        let t, e;
        this.height / this.width > this.imageAspect ? (t = this.width / this.height * this.imageAspect, e = 1) : (t = 1, e = this.height / this.width / this.imageAspect), this.material.uniforms.resolution.value.x = this.width, this.material.uniforms.resolution.value.y = this.height, this.material.uniforms.resolution.value.z = t, this.material.uniforms.resolution.value.w = e;
        let i = this.camera.position.z;
        this.camera.fov = 2 * (180 / Math.PI) * Math.atan(1 / (2 * i)), this.plane.scale.x = this.camera.aspect, this.plane.scale.y = 1, this.camera.updateProjectionMatrix()
    }
    addObjects() {
...
class ClapatSlider {
    constructor(t, e = {}) {
        ...
        this.opts = Object.assign({
        ...
        }, this.items = [], this.itemsInitial = [], this.itemsCloned = [], this.itemsPagination = [], this.tl = null, this.events = {
            ...
            resize: "resize"
        }, this.enabled = !0, this.length = 0, this.updater = gsap.set(this.updateUI, {
            delay: .2,
            ...
            tsSnap: null,
            events: []
        }, this.gl_canvas = null, this.init(), ClapatSlider.instances.push(this)
    }
    bindAll() {
    ...
    setupEvents() {
        let {
            ...
            wheel: n,
            mousewheel: l
        } = this.events, a = this.elEventTarget;
        null != a && (a.addEventListener(i, this.onDown), a.addEventListener(t, this.onMove), this.opts.mousewheel && (a.addEventListener(n, this.onWheel), a.addEventListener(l, this.onWheel)), window.addEventListener(e, this.onUp)), window.addEventListener(s, this.debounce(this.onResize, 250))
    }
    off() {
        let {
            move: t,
        ...
        null != a && (a.removeEventListener(i, this.onDown), a.removeEventListener(t, this.onMove), this.opts.mousewheel && (a.removeEventListener(n, this.onWheel), a.removeEventListener(l, this.onWheel)), window.removeEventListener(e, this.onUp)), null != this.btnNext && this.btnNext.removeEventListener("click", this.debounce(this.onNext, 50)), null != this.btnPrev && this.btnPrev.removeEventListener("click", this.debounce(this.onPrev, 50)), null != this.el && !1 != this.opts.click && this.el.removeEventListener("click", this.onClick), window.removeEventListener(s, this.debounce(this.onResize, 250)), this.updater.kill(), this.updater = null, gsap.ticker.remove(this.tick), clearInterval(this.threadAutoplay)
    }
    viewportSize() {
    ...
    setup() {
        ...
        for (let a = n.length - 1; a >= 0; a--) {
            let r = n[a],
                o = r.cloneNode(!0);
            "vertical" == this.opts.direction ? (r.style.top = 100 * a + "%", o.style.top = -(100 * l) + "%", o.classList.add(this.opts.clones), this.elInner.append(o)) : (r.style.left = 100 * a + "%", o.style.left = -(100 * l) + "%", o.classList.add(this.opts.clones), this.elInner.prepend(o)), l++
        }
        if (null != this.elPagination)
            for (let h = 0; h < n.length; h++) {
                n[h];
                let d = document.createElement("div");
                d.classList.add("clapat-pagination-bullet"), "function" == typeof this.opts.renderBullet && (d.innerHTML = this.opts.renderBullet()), this.elPagination.appendChild(d), d.addEventListener("click", this.onPagination), this.itemsPagination.push({
                    el: d
                })
            }
        ...
        for (let u = 0; u < p.length; u++) {
            let c = p[u],
                ...
                x = null;
            "vertical" == this.opts.direction ? (x = {
                el: c,
                start: v,
                end: f,
                length: w,
                ...
                length: $,
                translate: 0
            }, this.length += $), c.classList.contains(this.opts.clones) ? (this.itemsCloned.push(x), x.clone = !0) : (this.itemsInitial.push(x), x.clone = !1), this.items.push(x)
        }
        ...
        if ("vertical" == this.opts.direction) {
            for (let b = 0; b < E; b++) {
                let _ = this.items[b];
                0 == b ? _.prevElement = this.items[E] : _.prevElement = this.items[b - 1], b == E - 1 ? _.nextElement = this.items[this.items.length - 1] : _.nextElement = this.items[b + 1]
            }
            for (let y = this.items.length - 1; y >= E; y--) {
                let I = this.items[y];
                y == this.items.length - 1 ? I.prevElement = this.items[E - 1] : I.prevElement = this.items[y + 1], y == E ? I.nextElement = this.items[0] : I.nextElement = this.items[y - 1]
            }
        } else
            for (let L = 0; L < this.items.length; L++) {
                let S = this.items[L];
                0 == L ? S.prevElement = this.items[this.items.length - 1] : S.prevElement = this.items[L - 1], L == this.items.length - 1 ? S.nextElement = this.items[0] : S.nextElement = this.items[L + 1]
            }
        ...
        if (null != this.el && !1 != this.opts.click && this.el.addEventListener("click", this.onClick), this.setupWebGL(), gsap.ticker.add(this.tick), this.threadAutoplay = null, this.opts.autoplay) {
            let B = 5e3;
            this.isObject(this.opts.autoplay) && this.opts.autoplay.hasOwnProperty("speed") && (B = this.opts.autoplay.speed), B >= 500 && (this.threadAutoplay = setInterval(this.onNext, B))
        }
    }
    tick() {
        this.render()
    ...
    calc() {
        let t = this.state;
        if (t.current += (t.target - t.current) * this.opts.ease, t.prevRounded = t.currentRounded, t.currentRounded = Math.round(100 * t.current) / 100, t.prevRounded != t.currentRounded) {
            t.diff = t.target - t.currentRounded;
            let e = Math.round(-this.length / 2 * 100) / 100;
            t.progress = gsap.utils.wrap(0, 1, t.currentRounded / e), t.moveOffset = gsap.utils.wrap(0, this.length, Math.abs(t.currentRounded)), t.prevRounded > t.currentRounded && (t.currentMovingDirection = 1), t.prevRounded < t.currentRounded && (t.currentMovingDirection = -1), this.tl && this.tl.progress(t.progress)
        }
    }
    render() {
    ...
    transformItems() {
        ...
        for (let i = 0; i < this.items.length; i++) {
            ...
            n < 0 && s.end + n < t + e + s.length - this.length && (n += this.length), n > 0 && s.end + n > this.length && (n -= this.length), "vertical" == this.opts.direction ? s.el.style.transform = "translate(0, " + n + "px)" : s.el.style.transform = "translate(" + n + "px, 0)"
        }
    }
    updateUI() {
        let t = this.viewportSize(),
    ...
    updatePaginationUI() {
        if (this.opts.pagination && !(this.itemsPagination.length <= 0) && null != this.state.currentSlideItem) {
            ...
            for (let h = 0; h < this.itemsPagination.length; h++) {
                ...
                h != e && d.el.classList.remove("clapat-pagination-bullet-active"), h != r && d.el.classList.remove("clapat-pagination-bullet-next"), h != l && d.el.classList.remove("clapat-pagination-bullet-prev")
            }
        }
    }
    effects() {
        if ((null == this.opts.parallax || !1 == this.opts.parallax) && (null == this.opts.rotate || !1 == this.opts.rotate) && (null == this.opts.opacity || !1 == this.opts.opacity) && (null == this.opts.scale || !1 == this.opts.scale)) return;
        let t = this.viewportSize(),
            e = this.viewportShift();
                    ...
                    for (let r = 0; r < this.opts.parallax.length; r++) {
                        ...
                        if (void 0 !== o.element && void 0 !== o.margin) {
                            ...
                            for (let p = 0; p < h.length; p++) {
                                ...
                                if ("vertical" == this.opts.direction) {
                                    let m = /translateY\(([^)]+)\)/;
                                    g = c.search(m) >= 0 ? c.replace(m, "translateY(" + d + "%)") : c + " translateY(" + d + "%)"
                                } else {
                                    let v = /translateX\(([^)]+)\)/;
                                    g = c.search(v) >= 0 ? c.replace(v, "translateX(" + d + "%)") : c + " translateX(" + d + "%)"
                                }
                                u.style.transform = g
                            }
                        }
                        ...
                        if (void 0 !== $.element && void 0 !== $.factor) {
                            ...
                            for (let E = 0; E < w.length; E++) {
                                let b = w[E],
                                    ...
                                    y = /rotate\(([^)]+)\)/,
                                    I = "";
                                I = _.search(y) >= 0 ? _.replace(y, "rotate(" + x + "deg)") : _ + " rotate(" + x + "deg)", b.style.transform = I
                            }
                        }
                    }
                if (Array.isArray(this.opts.opacity))
                        ...
                        if (void 0 !== D.element && void 0 !== D.factor) {
                            ...
                            for (let W = 0; W < M.length; W++) {
                                let C = M[W],
                                    ...
                                    z = /scale\(([^)]+)\)/,
                                    O = "";
                                O = U.search(z) >= 0 ? U.replace(z, "scale(" + k + ")") : U + " scale(" + k + ")", C.style.transform = O
                            }
                        }
                    }
            }
    ...
    snapTargetOnDrag(t) {
        ...
        for (let l = 0; l < this.items.length; l++) {
            let a = this.items[l],
                r = s * n;
            r < 0 && a.end + r < e + i + a.length - this.length && (r += this.length), r > 0 && a.end + r > this.length && (r -= this.length);
    ...
    snapTargetOnWheel(t, e) {
        ...
        for (let r = 0; r < this.items.length; r++) {
            let o = this.items[r],
                h = n * l;
            h < 0 && o.end + h < i + s + o.length - this.length && (h += this.length), h > 0 && o.end + h > this.length && (h -= this.length);
        ...
        for (let c = 0; c < this.items.length; c++) {
            let g = this.items[c],
                m = p * u;
            m < 0 && g.end + m < i + s + g.length - this.length && (m += this.length), m > 0 && g.end + m > this.length && (m -= this.length);
            let v = g.start + m - (s + (i - g.length) / 2);
            if (Math.abs(v) < g.length / 2) {
                if (!(a == c && Math.abs(e - t) < this.length)) return this.log("Snapping - start and end items are different"), e - v;
                if (this.log("Snapping - start and end items are the same, the scroll did not go over a full item"), this.state.currentMovingDirection > 0) {
    ...
    onMove(t) {
        ...
        Math.abs(a) > Math.abs(r) && t.cancelable && t.preventDefault(), "vertical" == this.opts.direction ? e.target = n + r * this.opts.speed : e.target = n + a * this.opts.speed
    }
    onUp(t) {
        if (!this.enabled) return;
        this.log("on up");
    ...
    update() {
        ...
        for (let l = 0; l < this.items.length; l++) {
            let a = this.items[l],
                r = i * s;
            r < 0 && a.end + r < t + e + a.length - this.length && (r += this.length), r > 0 && a.end + r > this.length && (r -= this.length);
        ...
        this.state.currentRounded = this.state.current = this.state.target = S, this.state.off = this.state.target
    }
    onResize(t) {
    ...
    onPrev(t) {
        ...
        for (let l = 0; l < this.items.length; l++) {
            ...
            r < 0 && a.end + r < e + i + a.length - this.length && (r += this.length), r > 0 && a.end + r > this.length && (r -= this.length);
            let o = a.start + r - (i + (e - a.length) / 2);
            Math.abs(o) < a.length / 2 && (this.state.target = this.state.target - o + a.prevElement.length, this.state.off = this.state.target)
        }
    }
    onNext(t) {
        if (!this.enabled) return;
        ...
        for (let l = 0; l < this.items.length; l++) {
            ...
            r < 0 && a.end + r < e + i + a.length - this.length && (r += this.length), r > 0 && a.end + r > this.length && (r -= this.length);
            let o = a.start + r - (i + (e - a.length) / 2);
            Math.abs(o) < a.length / 2 && (this.state.target = this.state.target - (a.length / 2 + o + a.nextElement.length / 2), this.state.off = this.state.target)
        }
    }
    onWheel(t) {
        if (!this.enabled) return;
        ...
        if (this.log("Event timestamp: " + e + " Scroll delta " + n), this.opts.snap && null != this.snapWheelEvents.tsSnap) {
        ...
        i.target -= n * this.opts.speed, this.opts.snap && this.snapWheelEvents.events.push({
            ts: e,
            delta: n,
            currentTarget: i.target
        }), "vertical" == this.opts.direction ? o.y = i.target : o.x = i.target, i.off = i.target
    }
    updateWheelSnap() {
        ...
        let i = this,
            ...
            n = function(t) {
                ...
                if (i.state.prevRounded > i.state.currentRounded && n > i.state.progress) {
                    console.log("fBeginTransition: Moving forward but we rewind. Current index: " + t + " Position: " + i.state.progress);
                    return
                }
                if (i.state.prevRounded < i.state.currentRounded && n < i.state.progress) {
                    console.log("fBeginTransition: Moving backward but we fast forward. Current index: " + t + " Position: " + i.state.progress);
                    return
                }
                if (i.state.currentMovingDirection >= 0) {
                    console.log("fBeginTransition: Transition started - new current index " + t + " Moving forward. Position: " + i.state.progress);
                    let l = t + 1;
                    l >= a && (l = 0), s.material.uniforms.currentImage.value = s.textures[t], s.material.uniforms.currentImage.needsUpdate = !0, s.material.uniforms.nextImage.value = s.textures[l], s.material.uniforms.nextImage.needsUpdate = !0, s.material.uniforms.dispFactor.value = 0
                } else console.log("fBeginTransition: Transition started - new current index " + t + " Moving backward. Position: " + i.state.progress), s.material.uniforms.dispFactor.value = 1, s.material.uniforms.currentImage.value = s.textures[t], s.material.uniforms.currentImage.needsUpdate = !0, s.material.uniforms.nextImage.value = s.textures[t], s.material.uniforms.nextImage.needsUpdate = !0
            },
            l = function(t) {
                let e = Math.round(-i.length / 2 * 100) / 100,
                    n = gsap.utils.wrap(0, 1, i.state.prevRounded / e);
                if (i.state.prevRounded > i.state.currentRounded && n > i.state.progress) {
                    console.log("fEndTransition: Moving forward but we rewind. Current index: " + t + " Position: " + i.state.progress), s.material.uniforms.dispFactor.value = 0;
                    return
                }
                if (i.state.prevRounded < i.state.currentRounded && n < i.state.progress) {
                    console.log("fEndTransition: Moving backward but we fast forward. Current index: " + t + " Position: " + i.state.progress), s.material.uniforms.dispFactor.value = 0;
                    return
                }
                if (t >= a && (t = 0), i.state.currentMovingDirection < 0) {
                    console.log("fEndTransition: Transition ended - new current index " + t + " Moving backward. Position: " + i.state.progress);
                    let l = t - 1;
                    l < 0 && (l = a - 1), s.material.uniforms.currentImage.value = s.textures[l], s.material.uniforms.currentImage.needsUpdate = !0, s.material.uniforms.nextImage.value = s.textures[t], s.material.uniforms.nextImage.needsUpdate = !0, s.material.uniforms.dispFactor.value = 0
                } else console.log("fEndTransition: Transition ended - new current index " + t + " Moving forward. Position: " + i.state.progress), s.material.uniforms.currentImage.value = s.textures[t], s.material.uniforms.currentImage.needsUpdate = !0, s.material.uniforms.dispFactor.value = 0
            },
            a = s.images.length,
            r = 1 / a;
        if (i.opts.snap) {
            ...
            s.onTexturesLoaded = function() {
                ...
                for (let t = 0; t < a; t++) 0 == t ? i.tl.to({}, {
                    ...
                    duration: o
                }, ">").call(n, [t], ">").to(s.material.uniforms.dispFactor, {
                    duration: h,
                    value: 1,
                    ease: "Sine.easeInOut"
                }, ">").call(l, [t + 1], ">")
