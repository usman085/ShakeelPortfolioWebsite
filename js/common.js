    ...
    window.ScrollEffects = function() {
        ...
        if (isMobile()) {
            ...
            function setViewPortHeight() {
                ...
                gsap.set(".smooth-scroll main, .has-parallax, .clapat-nav-wrapper, .clapat-slider-wrapper:not(.content-slider), .showcase-lists .clapat-sync-slider, .slider-fixed-content", {
                    height: winHeight
                });
            }
        ...
        if ($('#hero').hasClass('has-image')) {
            ...
            function setheroImageProperties() {
                gsap.set(heroPinCaption, {
                    height: window.innerHeight
                });
                gsap.set(heroFullCaption, {
                    height: window.innerHeight
                });
                gsap.set(heroImage, {
                    height: window.innerHeight
        ...
        gsap.utils.toArray('.clipped-image-wrapper').forEach((clippedImageWrapper) => {
            ...
            function setClippedImageWrapperProperties() {
                ...
                gsap.set(clippedImageWrapper, {
                    height: window.innerHeight + clippedImageContent.offsetHeight - document.querySelector('.clapat-header').offsetHeight
                });
        ...
        $('#burger-wrapper, .menu .button-text').on('click', function() {
            ...
            setTimeout(function() {
                if ($('#menu-burger').hasClass("open")) {
                    ...
                    gsap.set($(".clapat-nav-wrapper ul ul li"), {
                        y: 0,
                        opacity: 1
                    });
                    ...
                    $body.on('mouseup mousemove', function handler(evt) {
                        if (evt.type === 'mouseup') {
                            ...
                            $('#itemsWrapperLinks .trigger-item-link, #itemsWrapperLinks .trigger-item-link-secondary').on('click', function() {
                                ...
                                gsap.to('#hero, #show-filters, .item-caption-wrapper, .showcase-portfolio .slide-caption, #page-nav, .clapat-footer, .fadeout-element', {
                                    duration: 0.5,
                                    opacity: 0,
                                    ease: Power4.easeInOut
                                });
    ...
    window.Shortcodes = function() {
        ...
        $("#copy-email").on('mouseenter', function() {
            ...
            if (!$(this).hasClass('copied')) {
                ...
                gsap.to($this.closest('.content-row'), {
                    opacity: 1,
                    duration: 0.3
                });
